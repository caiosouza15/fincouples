...
> **📖 Documentação completa:** Consulte [ARQUITETURA_FRONTEND.md](ARQUITETURA_FRONTEND.md) para padrões arquiteturais, design patterns, convenções e checklist de novas funcionalidades.
